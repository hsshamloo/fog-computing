...
function BrickletRealTimeClockV2(uid, ipcon) {
	...
	*/
	...
	this.callbackFormats[BrickletRealTimeClockV2.CALLBACK_DATE_TIME] = 'H B B B B B B B q';
	this.callbackFormats[BrickletRealTimeClockV2.CALLBACK_ALARM] = 'H B B B B B B B q';
	...
	this.setDateTime = function(year, month, day, hour, minute, second, centisecond, weekday, returnCallback, errorCallback) {
		...
		* Weekday: 1 to 7 (Monday to Sunday)
		...
		handled.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_DATE_TIME, [year, month, day, hour, minute, second, centisecond, weekday], 'H B B B B B B B', '', returnCallback, errorCallback, false);
	};
	this.getDateTime = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_DATE_TIME, [], '', 'H B B B B B B B q', returnCallback, errorCallback, false);
	};
	this.getTimestamp = function(returnCallback, errorCallback) {
		...
		second.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_TIMESTAMP, [], '', 'q', returnCallback, errorCallback, false);
	};
	this.setOffset = function(offset, returnCallback, errorCallback) {
		...
		configured once.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_OFFSET, [offset], 'b', '', returnCallback, errorCallback, false);
	};
	this.getOffset = function(returnCallback, errorCallback) {
		/*
		Returns the offset as set by :func:`Set Offset`.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_OFFSET, [], '', 'b', returnCallback, errorCallback, false);
	};
	this.setDateTimeCallbackConfiguration = function(period, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_DATE_TIME_CALLBACK_CONFIGURATION, [period], 'I', '', returnCallback, errorCallback, false);
	};
	this.getDateTimeCallbackConfiguration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_DATE_TIME_CALLBACK_CONFIGURATION, [], '', 'I', returnCallback, errorCallback, false);
	};
	this.setAlarm = function(month, day, hour, minute, second, weekday, interval, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_ALARM, [month, day, hour, minute, second, weekday, interval], 'b b b b b b i', '', returnCallback, errorCallback, false);
	};
	this.getAlarm = function(returnCallback, errorCallback) {
		/*
		Returns the alarm configuration as set by :func:`Set Alarm`.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_ALARM, [], '', 'b b b b b b i', returnCallback, errorCallback, false);
	};
	this.getSPITFPErrorCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_SPITFP_ERROR_COUNT, [], '', 'I I I I', returnCallback, errorCallback, false);
	};
	this.setBootloaderMode = function(mode, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_BOOTLOADER_MODE, [mode], 'B', 'B', returnCallback, errorCallback, false);
	};
	this.getBootloaderMode = function(returnCallback, errorCallback) {
		/*
		Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_BOOTLOADER_MODE, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.setWriteFirmwarePointer = function(pointer, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, [pointer], 'I', '', returnCallback, errorCallback, false);
	};
	this.writeFirmware = function(data, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_WRITE_FIRMWARE, [data], 'B64', 'B', returnCallback, errorCallback, false);
	};
	this.setStatusLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_SET_STATUS_LED_CONFIG, [config], 'B', '', returnCallback, errorCallback, false);
	};
	this.getStatusLEDConfig = function(returnCallback, errorCallback) {
		/*
		Returns the configuration as set by :func:`Set Status LED Config`
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_STATUS_LED_CONFIG, [], '', 'B', returnCallback, errorCallback, false);
	};
	this.getChipTemperature = function(returnCallback, errorCallback) {
		...
		temperature changes.
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_CHIP_TEMPERATURE, [], '', 'h', returnCallback, errorCallback, false);
	};
	this.reset = function(returnCallback, errorCallback) {
		...
		undefined behavior!
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_RESET, [], '', '', returnCallback, errorCallback, false);
	};
	this.writeUID = function(uid, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_WRITE_UID, [uid], 'I', '', returnCallback, errorCallback, false);
	};
	this.readUID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_READ_UID, [], '', 'I', returnCallback, errorCallback, false);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRealTimeClockV2.FUNCTION_GET_IDENTITY, [], '', 's8 s8 c B3 B3 H', returnCallback, errorCallback, false);
	};
}
